...
ALTER TABLE "PUBLIC"."SEAT"
    ADD CONSTRAINT "PUBLIC"."CONSTRAINT_26C" PRIMARY KEY ("ID");
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.SEAT;
ALTER TABLE "PUBLIC"."CUSTOMER"
    ADD CONSTRAINT "PUBLIC"."UK_MCXHS25405P3P7MRRE6HE23NF" UNIQUE ("DOCUMENT_NUMBER");
ALTER TABLE "PUBLIC"."BILLBOARD"
    ADD CONSTRAINT "PUBLIC"."FK_MOVIE_BILLBOARD" FOREIGN KEY ("ID_MOVIE") REFERENCES "PUBLIC"."MOVIE" ("ID") NOCHECK;
ALTER TABLE "PUBLIC"."SEAT"
    ADD CONSTRAINT "PUBLIC"."FK_ROOM_SEAT" FOREIGN KEY ("ID_ROOM") REFERENCES "PUBLIC"."ROOM" ("ID") NOCHECK;
ALTER TABLE "PUBLIC"."BOOKING"
    ADD CONSTRAINT "PUBLIC"."FK_CUSTOMER_BOOKING" FOREIGN KEY ("ID_CUSTUMER") REFERENCES "PUBLIC"."CUSTOMER" ("ID") NOCHECK;
ALTER TABLE "PUBLIC"."BILLBOARD"
    ADD CONSTRAINT "PUBLIC"."FK_ROOM_BILLBOARD" FOREIGN KEY ("ID_ROOM") REFERENCES "PUBLIC"."ROOM" ("ID") NOCHECK;
ALTER TABLE "PUBLIC"."BOOKING"
    ADD CONSTRAINT "PUBLIC"."FK_SEAT_BOOKING" FOREIGN KEY ("ID_SEAT") REFERENCES "PUBLIC"."SEAT" ("ID") NOCHECK;
ALTER TABLE "PUBLIC"."BOOKING"
    ADD CONSTRAINT "PUBLIC"."FK_BILLBOARD_BOOKING" FOREIGN KEY ("ID_BILLBOARD") REFERENCES "PUBLIC"."BILLBOARD" ("ID") NOCHECK;


insert into movie
values (null, true, 18, 'HORROR', 120, 'CHUCKY');
insert into movie
values (null, true, 12, 'COMEDY', 120, 'MI POBRE ANGELITO');
insert into movie
values (null, true, 18, 'ACTION', 120, 'RAMBO');

insert into room
values (null, true, 'SALA 1', 1);
insert into room
values (null, true, 'SALA 2', 2);
insert into room
values (null, true, 'SALA 3', 3);